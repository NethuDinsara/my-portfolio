...
const Extracurricular = () => {
  const activities = [
    { id: 1, title: "Project Chairperso - Sundown Motor Fest",  description: "Dedicated to helping communities through various initiatives, fostering a sense of social responsibility and making a tangible difference in the lives of others." },
